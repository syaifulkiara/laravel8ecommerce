...
<head>
	...
	<title>Home | Laravel Ecommerce</title>	
...
<body class="home-page home-01 ">
				...
				<div class="topbar-menu-area">
					<div class="container">
						<div class="topbar-menu left-menu">
							<ul>
								<li class="menu-item" >
									<a title="Hotline: (+62) 856 8183 606" href="#" ><span class="icon label-before fa fa-mobile"></span>Hotline: (+62) 856 8183 606</a>
								</li>
							</ul>
						</div>
					...
					<div class="primary-nav-section">
						<div class="container">
							<ul class="nav primary clone-main-menu" id="mercado_main" data-menuname="Main menu" >
								...
								<li class="menu-item">
									<a href="{{url('/')}}" class="link-term mercado-item-title">About Us</a>
								</li>
								<li class="menu-item">
								...
								<li class="menu-item">
									<a href="{{url('/')}}" class="link-term mercado-item-title">Contact Us</a>
								</li>																	
							</ul>
						</div>
					</div>
									...
									<div class="wrap-list-item apps-list">
										<ul>
											<li><a href="#" class="link-to-item" title="our application on apple store">
												<figure>
												<img src="{{ asset('assets/images/brands/apple-store.png')}}" alt="apple store" width="128" height="36"></figure></a>
											</li>
											<li><a href="#" class="link-to-item" title="our application on google play store">
												<figure>
													<img src="{{ asset('assets/images/brands/google-play-store.png')}}" alt="google play store" width="128" height="36"></figure></a></li>
										</ul>
									</div>
								</div>
							</div>
	...
	<script src="https://cdn.tiny.cloud/1/7tmtgw9eatday9vdhnbf7q1gftx2u0wytwdy441lel8fhxby/tinymce/5/tinymce.min.js" referrerpolicy="origin"></script>
	@livewireScripts
